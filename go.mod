module github.com/apparentlymart/terraform-provider-deepmerge
...
require (
	...
	github.com/apparentlymart/go-tf-func-provider v0.0.0-20240411175800-ddb0ac26dd34 // indirect
